...
![Landing Page (Login Form) with username or password includes ":"](/assets/images/on_load.jpg "Index Page for invalid input")
## The index page if a user attempts to create a username or password that includes the ":" character.
![Landing Page (Login Form) if password invalid](/assets/images/username_taken.jpg "Index Page for invalid password")
